<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Halaman Aktivasi Outlet | Survei Enseval</title>
...
<body class="skin-green">
    <section class="content">
        <form  role="form" action="<?php echo base_url(); ?>site/SaveData" method="POST" enctype="multipart/form-data">
            <div class="box">
                <span id="pesan-flash1"><?php echo $this->session->flashdata('sukses'); ?></span>
                    ...
                    <div class="box-body chat" id="chat-box">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="" id="" name="id_outlet" placeholder="Masukan User Id" required>                        
                            </div>
                            <div class="form-group">
