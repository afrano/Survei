...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/Login/css/style.css" type="text/css" media="all"/>    
        <!-- //css files -->
        <!-- web-fonts -->
    ...
    <body>
            ...
            <div class="wthree-form">
                ...
                <form action="<?php echo base_url(); ?>login/proseslog" id="form-login" method="post" accept-charset="utf-8">
                    ...
                    <label class="anim">
                        ...
                        <a href="<?php echo base_url(); ?>site/Aktivasi">Regestrasi Akun</a>
                    </label> 
                    <div class="clear"></div>
        ...
        <!--footer-->
        <div class="footer">
            <p>Copyright © 2017.   PT Enseval Putera Megatrading Tbk.</p>
        </div>
        <!--//footer-->
    </body>
    <style>
        ...
        body {
            ...
            background:url(assets/img/hero.jpg) no-repeat 0px 0px;
